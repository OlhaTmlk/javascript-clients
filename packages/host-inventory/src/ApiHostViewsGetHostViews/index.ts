...
/**
* **[Work In Progress]** This endpoint is under active development and currently returns HTTP 501 (Not Implemented).<br /><br /> Read a combined view of hosts with optional application data such as Advisor, Vulnerability, Compliance, Patch, and others. Application joins are opt-in and controlled through the fields parameter.<br /><br /> Required permissions: inventory:hosts:read
* @summary [WIP] Read aggregated host and application data
